...
describe('YearlyGoalsComponent', () => {
  ...
  describe('Tag Filtering', () => {
    beforeEach(() => {
      component.goals = [
        { id: 1, text: 'Goal 1', completed: false, tags: ['survive', 'create'], scope: 'year', periodKey: '2026', createdAt: '', updatedAt: '' }
      ];
    });
  ...
  describe('Tag Input Management', () => {
    beforeEach(() => {
      component.goals = [
        { id: 1, text: 'Goal 1', completed: false, tags: [], scope: 'year', periodKey: '2026', createdAt: '', updatedAt: '' },
        { id: 2, text: 'Goal 2', completed: false, tags: [], scope: 'year', periodKey: '2026', createdAt: '', updatedAt: '' }
      ];
    });
